...
MDrive3: (For X control):
Reactor 0#  50  #48 - 53,  far inside the chamber, stir 3
Reactor 1#  85   #82 -88  , stir 2, 
Reactor 2:  120   #117 - 123, close to the door, sirt 1 


proposal_swap(317378)
%run -i /home/xf12id/SWAXS_user_scripts/CFN/Yugang/YZhang_SMI_Base.py
project_set('Digestive Ripening')
%run -i /home/xf12id/SWAXS_user_scripts/CFN/Yugang/2026C2_Flow.py

Data Saved in 
/nsls2/users/yuzhang/smi_proposals_link/2026-2/pass-317378/projects/Digestive_Ripening
Handshake folder:



%run -i /home/xf12id/SWAXS_user_scripts/CFN/Yugang/2026C2_CNam.py
Put a AgBH power inside the reactor for calibration
 %run -i /home/xf12id/SWAXS_user_scripts/CFN/Yugang/2026C1_ThreeGroups.py
...
'''
Huber: X -28 , Y -30, Z = 2 # don't move this, only change MDrive3 for X-control

MDrive3: (For X control):
Reactor 1: 50  #48 - 53
Reactor 2: 85   #82 -88 
Reactor 2: 120   #117 - 123
