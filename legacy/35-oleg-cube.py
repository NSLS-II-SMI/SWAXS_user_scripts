...
def aaron_rot(t=5):
    ...
    yield from bp.inner_product_scan([pil2M], 15, prs, 60, 46, piezo.x, 5550, 5580)
    yield from bp.inner_product_scan([pil2M], 45, prs, 45, 0, piezo.x, 5580, 5640)
    yield from bp.inner_product_scan([pil2M], 45, prs, 1, -45, piezo.x, 5640, 5641)
    yield from bp.inner_product_scan([pil2M], 15, prs, -46, -60, piezo.x, 5640, 5641)
